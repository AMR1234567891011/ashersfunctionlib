...
emcc -O3 \
  -sWASM=1 \
  -sEXPORTED_FUNCTIONS='[_x3dh_woR,_x3dh_woS,_main_tests, _scalar_mult, _wasm_init_sessions,_wasm_new_session,_wasm_send_message,_wasm_receive_message,_malloc,_free]' \
